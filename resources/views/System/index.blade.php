        ...
        <div class="container-fluid px-1 py-5 mx-auto">
            <div class="row d-flex justify-content-center">
                <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                    ...
                    <div class="card_ia card bg-light">
                        <h2 class="text-center mb-4 text-secondary">Sistema de recomendacion de cultivos</h2>
                        <form class="form-card" onsubmit="event.preventDefault()">
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-sm-6 flex-column d-flex">

                                    <select class="border-0 shadow-sm m-2 p-2 rounded" id="purpose" name="purpose"
                                        onchange="validate(1)">
                                        <option value="" selected disabled>Proposito</option>
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex">
                                    <select class="border-0 shadow-sm m-2 p-2 rounded" id="order" name="order"
                                        onchange="validate(1)">
                                        <option value="" selected disabled>Citerio de Orden</option>
                                        <option value="John">John</option>
                                        <option value="Jane">Jane</option>
                                        <option value="Doe">Doe</option>
                                    </select>
                            ...
                            <div class="row justify-content-center text-left">
                                <div class="form-group col-sm-5 flex-column d-flex">
                                    <input class="border-0 shadow-sm m-2 p-2 rounded" type="number" id="quantity"
                                        name="quantity" max="10" min="1"
                                        placeholder="Numero de Familias Recomendadas">
                                </div>
                            </div>
                            <div class="row justify-content-between text-left">
                                <div class="form-group col-12 flex-column d-flex"> <label
                                        class="form-control-label px-3">Para que pais sera el envio?<span
                                            class="text-danger"> *</span></label>
                                    <div class="form-group col-12 flex-column d-flex m-2 p-2">
                                        <select class="js-example-theme-single" required name="country" id="country">
