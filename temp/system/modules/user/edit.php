    ...
    <div class="card-body">
        <form action="" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                ...
                <input type="text" value="<?php echo $textID; ?>" class="form-control" readonly name="id" id="id" aria-describedby="helpId" placeholder=" ">
            </div>
            <div class="mb-3">
                <label for="nombreusuario" class="form-label">Nombre Usuario</label>
                <input type="text" value="<?php echo $name; ?>" class="form-control" name="nombreusuario" id="nombreusuario" aria-describedby="helpId" placeholder="Carlos">
            </div>
            <div class="mb-3">
                <label for="passwordusuario" class="form-label">Password Usuario</label>
                <input type="password" value="<?php echo $pass; ?>" class="form-control" name="passwordusuario" id="passwordusuario" aria-describedby="helpId" placeholder="*******">
            </div>
            <div class="mb-3">
                <label for="emailusuario" class="form-label">Email Usuario</label>
                <input type="email" value="<?php echo $correo; ?>" pattern="[^ @]*@[^ @]*" class="form-control" name="emailusuario" id="emailusuario" aria-describedby="helpId" placeholder="Carlos@gmail.com">
            </div>
 
            <button type="submit" class="btn btn-success">Actualizar</button>

            <a name="" id="" class="btn btn-danger" href="<?php echo $url_base; ?>system/modules/user/index.php" role="button">Cancelar</a>
        </form>
    </div>
